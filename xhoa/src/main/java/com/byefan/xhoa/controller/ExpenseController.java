...
//        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("startEvent1", map);
...
//        list.forEach(identityLink -> System.out.println(identityLink));
    ...
    public void genProcessDiagram(HttpServletResponse response, String processId) throws Exception {
        ...
        InputStream in = diagramGenerator.generateDiagram(bpmnModel,
                "PNG", activityIds, flows, "宋体", "宋体", "宋体", null, 1.0, true);
