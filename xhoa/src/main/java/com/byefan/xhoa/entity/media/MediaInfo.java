...
//    private Map<String,Object> n2Map;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, remarks, userId, creatorId, updateDate, supplierId, supplierName, supplier,  picPath, commStart, mType, d1, d2, n1, c1, c2, c3, c4, n2, n3, n4, n5, n6, n7, n8, discount, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, mediaType, user, creator, state, n1Data, n2Data, n3Data, n4Data, n5Data, n6Data, n7Data, n8Data);
    }
}