...
//    @Relate(name = Dept.class, fkName = "dept_id")
    ...
    public boolean equals(Object o) {
        ...
        return isMJ == user.isMJ &&
                ...
                Objects.equals(isMgr, user.isMgr) &&
                Objects.equals(mgrId, user.mgrId) &&
                ...
                Objects.equals(failNum, user.failNum) &&
                Objects.equals(no, user.no) &&
                Objects.equals(mac, user.mac) &&
                Objects.equals(deptId, user.deptId) &&
                Objects.equals(deptName, user.deptName) &&
                Objects.equals(deptIdSet, user.deptIdSet) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userName, password, name, image, sex, phone, qq, wechat, email, isMgr, mgrId, remark, state, creator, createTime, updateUserId, updateTime, loginTime, loginIp, failNum, no, mac, deptId, deptName, deptIdSet, roles, isMJ, dept);
    }
}
