...
public class POIUtil {
    ...
    public static String wordToHtml(String fileName, String uploadDir, String wordPath, String webDir) {
...
//            // html中图片的路径
    ...
    public static String word03ToHtml(String fileName, String uploadDir, String wordPath, String webDir) {
        String htmlPath = uploadDir + "htmls/" + fileName + ".html";
        FileWriter out = null;
        try {
