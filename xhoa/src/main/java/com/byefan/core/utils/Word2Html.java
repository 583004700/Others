...
//     * @throws Exception
//     */
//    private static void readTable(TableIterator it, Range range) throws Exception {
//
//        htmlTextTbl = "";
//        // 迭代文档中的表格
//
...
//        int picHeight = pic.getHeight() * pic.getDyaGoal() / 100;
//        int picWidth = pic.getDxaGoal() * pic.getWidth() / 100;
//
//
//        if (picWidth > 500) {
