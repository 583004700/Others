...
class TestParameterizedType1 extends Person<Boolean,Integer>{

}

public class TestParameterizedType extends Person<Integer,String> {

    public static void main(String[] args) {
        TestParameterizedType1 student = new TestParameterizedType1();
