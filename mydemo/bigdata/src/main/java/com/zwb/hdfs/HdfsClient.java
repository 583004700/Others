...
public class HdfsClient {
	...
	public void init() throws Exception {
		...
		fs = FileSystem.get(new URI("hdfs://zwb107:9000"), conf, "root");
	...
	public void testAddFileToHdfs() throws Exception {
		...
		// 要上传到hdfs的目标路径*/
		Path src = new Path("d:/test/up.txt");
		Path dst = new Path("/");
	...
	public void testAddFileToHdfs2() throws Exception {
		InputStream in = new FileInputStream("d:/test/流的方式上传.txt");
		Path dst = new Path("/a/流的方式上传.txt");
	...
	public void testDownloadFileToLocal2() throws Exception {
		OutputStream out = new FileOutputStream("d:/test/下载.txt");
		InputStream in = fs.open(new Path("/a/流的方式上传.txt"));
		IOUtils.copy(in,out);
		fs.close();
	}
