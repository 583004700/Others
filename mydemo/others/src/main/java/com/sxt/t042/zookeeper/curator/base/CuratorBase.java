package com.sxt.t042.zookeeper.curator.base;
...
public class CuratorBase {
	...
	public static void main(String[] args) throws Exception {
		...
		//2 通过工厂创建连接
		CuratorFramework cf = CuratorFrameworkFactory.builder() //1 new CuratorFrameworkFactory.Builder()
					.connectString(CONNECT_ADDR)
					.sessionTimeoutMs(SESSION_OUTTIME)
					.retryPolicy(retryPolicy)
//					.namespace("super")
					.build(); //2 new CuratorFrameworkImpl(1)
		//3 开启连接
		cf.start();
		...
		cf.create() //3 new CreateBuilderImpl(2)
		.creatingParentsIfNeeded() //4 new ProtectACLCreateModeStatPathAndBytesable<String>()
				.withMode(CreateMode.PERSISTENT) //5 return 3
