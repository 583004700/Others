...
public class FlowSumOneStepSort {
...
//		job.setJar("/root/wordcount.jar");
        job.setJarByClass(FlowSumOneStepSort.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("d://flowsum/outputonestep"));
