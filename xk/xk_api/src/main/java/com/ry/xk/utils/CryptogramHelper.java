...
public class CryptogramHelper
{
    ...
    {
        /**
         * DocumentPrintOutput output = new DocumentPrintOutput(); output.setComfrimResult("3");
         * output.setErrorCode("4"); output.setErrorMsg("5"); output.setFreezeAmount(6);
         * output.setPrintScene("7"); System.out.println(sign(beanToMap(output), "ruanyun"));
         **/
        // 返回前端的，我们需要这样加密
        // int partnerId = 10;
        // String orgId = encryptThreeDESECB("appId", CommonConst.DESKEY);
        // System.out.println(orgId);

        // 前端入参传给我们后，我们需要这样解密

        // System.out.println(encryptThreeDESECB("10000",
        // "lQa9_&skzly%!9fs2@*UNA($ck_^:)'aI9e.^2Lbx9,5lf!j+~Hz@^hakuJ^crOb"));
        // System.out.println(decryptThreeDESECB("KiBdnLreApCDdTkoUBaJ+vhw3aeL6tFRaWdt/tjXjPV8XKEhNP31DXMQUFae4p+6",
        // CommonConst.DESKEY));

        // System.out.println(decryptThreeDESECB("1ol2XmPL5I2Ak+oGiqwVCk3p+J3ILZt2LjUh502UFEPS/uHcWgOsC1yZlBhxXx3TscoyzlfrwNk=",
        // CommonConst.DESKEY));
        // System.out.println(encryptThreeDESECB("XK-ExamResult;ruanyun2014;http://10.0.7.35:8091/pools",
        // CommonConst.DESKEY));
         ...
         * CommonConst.DESKEY)); System.out.println(
