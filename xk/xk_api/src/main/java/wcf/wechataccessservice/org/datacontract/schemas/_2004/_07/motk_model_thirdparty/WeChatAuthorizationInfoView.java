...
/**
 * <p>WeChatAuthorizationInfoView complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="WeChatAuthorizationInfoView"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "WeChatAuthorizationInfoView", namespace = "http://schemas.datacontract.org/2004/07/Motk.Model.ThirdParty.View", propOrder = {
    "accessToken",
    "expiresIn",
    "openId",
    "refreshTick"
})
public class WeChatAuthorizationInfoView
    extends ResultBase
{
