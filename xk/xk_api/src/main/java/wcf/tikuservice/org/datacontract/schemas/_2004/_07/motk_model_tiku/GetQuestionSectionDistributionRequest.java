...
/**
 * <p>GetQuestionSectionDistributionRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GetQuestionSectionDistributionRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="NumberOfQuestionByKnowledgePoint" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&gt;
...
@XmlType(name = "GetQuestionSectionDistributionRequest", namespace = "http://schemas.datacontract.org/2004/07/Motk.Model.Tiku.Request", propOrder = {
    "courseId",
    "knowledgePointIds",
    "numberOfQuestionByKnowledgePoint",
    "sectionIds"
})
public class GetQuestionSectionDistributionRequest
    extends RequestBase
{
    ...
    @XmlElement(name = "NumberOfQuestionByKnowledgePoint")
    protected Integer numberOfQuestionByKnowledgePoint;
    ...
    /**
     * 获取numberOfQuestionByKnowledgePoint属性的值。
     * 
     * @return
     *     possible object is
     *     {@link Integer }
     *     
     */
    public Integer getNumberOfQuestionByKnowledgePoint() {
        return numberOfQuestionByKnowledgePoint;
    }

    /**
     * 设置numberOfQuestionByKnowledgePoint属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setNumberOfQuestionByKnowledgePoint(Integer value) {
        this.numberOfQuestionByKnowledgePoint = value;
    }
