...
/**
 * <p>BookVersionView complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="BookVersionView"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BookVersionView", propOrder = {
    "bookVersionId",
    "bookVersionName",
    "bookVersionSource",
    "courseId",
...
public class BookVersionView {

    @XmlElement(name = "BookVersionId")
    protected Integer bookVersionId;
    @XmlElementRef(name = "BookVersionName", namespace = "http://schemas.datacontract.org/2004/07/Motk.Model.Tiku.View", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "PublisherBookVersion", namespace = "http://schemas.datacontract.org/2004/07/Motk.Model.Tiku.View", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "PublisherLogoPath", namespace = "http://schemas.datacontract.org/2004/07/Motk.Model.Tiku.View", type = JAXBElement.class)
