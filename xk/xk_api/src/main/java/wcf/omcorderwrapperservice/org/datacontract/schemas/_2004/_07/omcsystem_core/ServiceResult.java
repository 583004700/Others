...
@XmlSeeAlso({
    ...
    ServiceResultOfOrderPayResultdNPiHdpe.class,
    ServiceResultOfPageOfOrderdNPiHdpem06JEnuP.class,
    ServiceResultOfOrderdNPiHdpe.class,
    ServiceResultOfArrayOfOrderStatusQuantitydNPiHdpe.class,
    ServiceResultOfTransactionType5Y56Hjij.class,
    ServiceResultOfboolean.class,
    ServiceResultOfArrayOfOrderPayModedNPiHdpe.class
})
