...
@XmlRootElement(name = "SendFreeOrderSuccessEvent")
public class SendFreeOrderSuccessEvent {

    @XmlElementRef(name = "orderNo", namespace = "http://tempuri.org/", type = JAXBElement.class)
